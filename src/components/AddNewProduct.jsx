...
export default function AddNewProduct(props) {
  ...
  const addProduct = () => {
    setLoading(true);
    axios
      .post(url + "/shopping-lists/addproduct", {
        id: props.listId,
        product: productName,
      })
      .then((response) => {
  ...
  return (
    <div>
      <button
        ...
        className="flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded-lg bg-blue-700 hover:bg-blue-800   dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
      >
        <svg
